 ...
 * @since 0.2
 */
public class MyLifecycleBeanPostProcessor implements DestructionAwareBeanPostProcessor, PriorityOrdered {

    /**
     * Private internal class log instance.
     */
    private static final Logger log = LoggerFactory.getLogger(MyLifecycleBeanPostProcessor.class);
     ...
     * Default Constructor.
     */
    public MyLifecycleBeanPostProcessor() {
     ...
     */
    public MyLifecycleBeanPostProcessor(int order) {
        this.order = order;
    }
